          ...
          child: Row(
            ...
            children: [
              for (var index = 0; index < stages.length; index++) ...[
                _StageColumn(stage: stages[index].stage, matches: stages[index].matches, state: state),
...
class _StageColumn extends StatelessWidget {
  ...
  const _StageColumn({required this.stage, required this.matches, required this.state});
