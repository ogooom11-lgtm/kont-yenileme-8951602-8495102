      ...
      child: InkWell(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          Container(
            ...
            decoration: BoxDecoration(gradient: LinearGradient(colors: [color, color.withValues(alpha: 0.82)])),
          ...
          Padding(padding: const EdgeInsets.fromLTRB(16, 13, 16, 14), child: Column(children: [
            ...
            ClipRRect(borderRadius: BorderRadius.circular(8), child: LinearProgressIndicator(value: progress, color: color, minHeight: 7, backgroundColor: color.withValues(alpha: 0.13))),
